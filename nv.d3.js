      ...
      bars
          ...
          .on('mouseover', function(d,i) { //TODO: figure out why j works above, but not here
            ...
            dispatch.elementMouseover({
              ...
              point: d,
              series: data[d.series],
              pos: [x(getX(d,i)) + (x.rangeBand() * (stacked ? data.length / 2 : d.series + .5) / data.length), y(parseFloat(getY(d,i)) || 0 + (stacked ? d.y0 : 0))],  // TODO: Figure out why the value appears to be shifted
              pointIndex: i,
              seriesIndex: d.series,
              e: d3.event
            });
      ...
      bars
          .on('mouseover', function(d,i) { //TODO: figure out why j works above, but not here
            ...
            dispatch.elementMouseover({
              ...
              point: d,
              series: data[d.series],
              pos: [ y(parseFloat(getY(d,i)) || 0 + (stacked ? d.y0 : 0)), x(getX(d,i)) + (x.rangeBand() * (stacked ? data.length / 2 : d.series + .5) / data.length) ],
              pointIndex: i,
              seriesIndex: d.series,
              e: d3.event
            });
          ...
          .on('click', function(d,i) {
            dispatch.elementClick({
              ...
              point: d,
              series: data[d.series],
              pos: [x(getX(d,i)) + (x.rangeBand() * (stacked ? data.length / 2 : d.series + .5) / data.length), y(parseFloat(getY(d,i)) + (stacked ? d.y0 : 0))],  // TODO: Figure out why the value appears to be shifted
              pointIndex: i,
              seriesIndex: d.series,
              e: d3.event
            });
